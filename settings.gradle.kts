...
include(":podcast")
include(":podcast:model")
include(":podcast:parser:feed")
include(":podcast:parser:media")
include(":podcast:net:common")
include(":podcast:net:download")
...
include(":podcast:storage:preferences")
