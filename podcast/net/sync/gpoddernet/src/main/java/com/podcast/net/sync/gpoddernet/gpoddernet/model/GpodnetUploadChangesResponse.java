package com.podcast.net.sync.gpoddernet.gpoddernet.model;

import androidx.collection.ArrayMap;
import com.podcast.net.sync.gpoddernet.gpoddernet.GpodnetService;
import com.podcast.net.sync.model.UploadChangesResponse;
...
public class GpodnetUploadChangesResponse extends UploadChangesResponse {
     ...
     *
     * @throws JSONException If the method could not parse the JSONObject.
     */
