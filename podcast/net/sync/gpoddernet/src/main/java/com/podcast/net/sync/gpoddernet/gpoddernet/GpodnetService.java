...
import com.podcast.net.sync.gpoddernet.HostnameParser;
import com.podcast.net.sync.gpoddernet.gpoddernet.mapper.ResponseMapper;
import com.podcast.net.sync.gpoddernet.gpoddernet.model.GpodnetDevice;
import com.podcast.net.sync.gpoddernet.gpoddernet.model.GpodnetEpisodeActionPostResponse;
import com.podcast.net.sync.gpoddernet.gpoddernet.model.GpodnetPodcast;
import com.podcast.net.sync.gpoddernet.gpoddernet.model.GpodnetUploadChangesResponse;
import com.podcast.net.sync.model.*;
import okhttp3.*;
...
public class GpodnetService implements ISyncService {
     ...
     */
    @Override
    public UploadChangesResponse uploadEpisodeActions(List<EpisodeAction> episodeActions) throws
