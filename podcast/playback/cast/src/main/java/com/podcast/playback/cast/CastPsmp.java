package com.podcast.playback.cast;
...
import com.podcast.event.PlayerErrorEvent;
import com.podcast.event.playback.BufferUpdateEvent;
import com.podcast.model.feed.FeedMedia;
import com.podcast.model.playback.MediaType;
import com.podcast.model.playback.Playable;
import com.podcast.model.playback.RemoteMedia;
import com.podcast.playback.base.PlaybackServiceMediaPlayer;
import com.podcast.playback.base.PlayerStatus;
import com.podcast.playback.base.RewindAfterPauseUtils;
...
public class CastPsmp extends PlaybackServiceMediaPlayer {
    ...
    public static PlaybackServiceMediaPlayer getInstanceIfConnected(@NonNull Context context,
        ...
        try {
            if (CastContext.getSharedInstance(context, context.getMainExecutor()).getResult().getCastState() == CastState.CONNECTED) {
    ...
    public CastPsmp(@NonNull Context context, @NonNull PSMPCallback callback) {
        ...
        castContext = CastContext.getSharedInstance(context, context.getMainExecutor()).getResult();
