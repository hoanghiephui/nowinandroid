package com.podcast.parser.media.id3;

import android.text.TextUtils;
import android.util.Log;
import androidx.annotation.NonNull;
import com.podcast.model.feed.Chapter;
import com.podcast.model.feed.EmbeddedChapterImage;
import com.podcast.parser.media.id3.model.FrameHeader;
        ...
        switch (frameHeader.getId()) {
            ...
            case FRAME_ID_PICTURE:
                ...
                if (MIME_IMAGE_URL.equals(mime)) {
                    ...
                    if (TextUtils.isEmpty(chapter.getImageUrl()) || type == IMAGE_TYPE_COVER) {
                        chapter.setImageUrl(
                                EmbeddedChapterImage.makeUrl(getPosition(), rawImageDataLength));
                    }
                }
                break;
            default:
